...
For most of our evaluations, we use $k=1$ and $k=10$. We chose $k=10$ somewhat arbitrarily, as it provides a balance between being too strict by only measuring the top results and being too lax by allowing lower-scored retrieved passages to be included in the analysis. In case the amount of ground truths in a query is less than $k$, we will intentionally chooose our evaluation metrics in such a way to avoid misrepresenting the results. 
