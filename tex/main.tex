...
Continuously updating the corpora has been a central challenge in \gs{GR}. Several models have been proposed for solving such issues, such as using frozen pre-trained \gp{LM} \cite{kishore2024incdsiincrementallyupdatabledocument, 0.1145/3763233} %cite better explanation,
...
\gs{GR} has mostly been applied and tested \gs{KILT} \cite{petroni-etal-2021-kilt} tasks, such as fact verification, open-domain QA, conversational QA, entity linking, or recommender systems \cite{TODO}.
