...
def calculate_retrieval_metrics(retrieved_ids, gold_ids):
    """
    Calculate precision@1, hits@10, hits@100, and R-precision for retrieval results.
    ...
    Returns:
        dict: Contains "precision_at_1", "hits_at_10", "hits_at_100", and "r_precision"
    """
    if not gold_ids:
        return {"precision_at_1": 0.0, "hits_at_10": 0.0, "hits_at_100": 0.0, "r_precision": 0.0}
    ...
    # Hits@100: 1 if any of top-100 retrieved documents are relevant, else 0
    top_100 = retrieved_ids[:100]
    hits_100 = 1.0 if any(pid in gold_ids for pid in top_100) else 0.0
