...
Contrary to our initial hypothesis, the results reveal a negative correlation between diversity and retrieval success ($\rho = -0.227$, $p < 0.001$). Queries with low-diversity (highly repetitive) n-grams achieved a 55.3\% precision\@1, compared to only 35.5\% for high-diversity queries.
...
The relationship between such single-query dominance and retrieval success demonstrates a weak but clear negative correlation (Spearman $\rho = -0.115$, $p < 0.001$). Stratified into 10 bins, queries in the lowest ratio bin (0.12–0.30) achieve a precision\@1 of approximately 48.5\%, while queries in the highest bin (0.57–0.85) achieve only 29.4\%.
