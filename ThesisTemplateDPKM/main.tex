...
\subsection{Data Refinement Results} %(LLM-Judge verdicts and the adjusted recall table) TODO ACCORDINGLY SHOULD I UPDATE THE ORIGINAL DATASET OR NO? SHOULD I DO THE SAME WITH MINDER TOO OR NO?
\label{sec:llmresults}

According to the methodology explained in Section \ref{sec:llm-judge}, we adjust the estimate of \glsxtrshort{SEAL}'s retrieval performance. Table~\ref{tab:adjusted-recall} presents the adjusted top-2 recall under different inclusion criteria.
